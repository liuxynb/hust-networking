...
void sendData(const char* fileName, SOCKET clientSocket) {
    ...
    // Check if the file is forbidden (e.g., based on some conditions).
    // bool isForbidden = false; // Replace this with your actual logic.
    // if (isForbidden) {
    ...
    // Send the 200 OK response header to the client.
...
int main() {
    ...
    while (1) {
        ...
        char fileName[1000] = "";
        strcat(fileName, "C:\\Users\\20963\\Desktop\\Grade3\\���������\\lab\\socket-programming\\"); // Base path
